...
def main():
    ...
    rate_df = pd.read_csv(args.rates)[["chamber", "source_abs", "rate"]]
    rate_df = rate_df[rate_df.chamber==3][["source_abs", "rate"]]
    ...
    resolution_ax.errorbar(rate_nocomp, scan_df_nocomp["space_resolution"], scan_df_nocomp["err_space_resolution"], fmt="o--", label="No compensation", color="red")
    resolution_ax.errorbar(rate_comp, scan_df_comp["space_resolution"], scan_df_comp["err_space_resolution"], fmt="o--", label="Compensation", color="blue")
    resolution_ax.set_xlabel("Background rate (kHz/strip)")
    ...
    cls_ax.set_xlabel("Background rate (kHz/strip)")
